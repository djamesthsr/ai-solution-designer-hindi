  ...
  const bookPagesHi = {
    ...
    problem: {
      ...
      options: [
        ...
        "छात्र रोज़ कैंटीन के 35% भोजन को तैयारी की गलत मात्रा के कारण बर्बाद कर देते हैं।",
    ...
    data: {
      ...
      icon: "📊",
      text: "एआई उदाहरणों के माध्यम से सीखता है। डेटा चरण वह जगह है जहाँ हम यह तय करते हैं कि कौन से मापदंड अनुमान लगाते हैं, ऐतिहासिक रिकॉर्ड इकट्ठा करते हैं, और डेटासेट को साफ करते हैं। याद रखें: कचरा डेटा कचरा मॉडल बनाता है। हमें प्रासंगिक, नैतिक और प्रतिनिधि जानकारी एकत्र करनी होगी।",
    ...
    model: {
      ...
      icon: "🧠",
      text: "यह वह जगह है जहाँ एआई एल्गोरिदम को प्रशिक्षित किया जाता है। हम अपने साफ किए गए डेटा को अपने मॉडल में फीड करते हैं ताकि यह अंतर्निहित पैटर्न सीख सके। विभिन्न समस्याओं के लिए अलग-अलग मॉडल परिवारों की आवश्यकता होती है: पूर्वानुमान के लिए प्रतिगमन मॉडल, चित्रों के वर्गीकरण के लिए वर्गीकरण मॉडल, और निर्णयों को बेहतर बनाने के लिए अनुकूलन एल्गोरिदम।",
    ...
    output: {
      ...
      icon: "🖥️",
      text: "यदि लोग उनका उपयोग नहीं कर सकते तो मॉडल का अनुमान लगाना बेकार हैं। आउटपुट चरण कच्चे मूल्यों को स्पष्ट, उपयोगकर्ता-अनुकूल डैशबोर्ड, नियंत्रण फ़ीड या स्वचालित स्विच में बदल देता है। यह वह जगह भी है जहाँ हम मूल्यांकन करते हैं कि क्या मॉडल नैतिक, निष्पक्ष और उच्च सुरक्षा के साथ काम करता है।",
